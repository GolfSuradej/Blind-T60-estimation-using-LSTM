...
def maybe_download(file, work_directory):
  ...
  if not os.path.exists(filepath):
    print("golf: files already exits in work directory -> Ok!")#golf comments
  ...
  if os.path.exists(filepath):
   #golf  print('Extracting %s to %s' % ( filepath, work_directory))
   #golf os.system('tar xf %s -C %s' % ( filepath, work_directory))
    print('Data ready!')
